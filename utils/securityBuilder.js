...
function buildOverviewComponents(cfg) {
  // ROW 1: AutoMod Buttons
  const row1 = new ActionRowBuilder().addComponents(
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-general')
      .setLabel('⚙️ Allgemein')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-spam')
      .setLabel('📨 Spam Schutz')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-links')
      .setLabel('🔗 Link Schutz')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-mentions')
      .setLabel('📢 Mention Spam')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-caps')
      .setLabel('🔡 Caps Schutz')
      .setStyle(ButtonStyle.Primary),
  );

  // ROW 2: System Buttons
  const row2 = new ActionRowBuilder().addComponents(
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-verification')
      .setLabel('✅ Verification')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-antiraid')
      .setLabel('🚨 Anti Raid')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-roles')
      .setLabel('👮 Security Rollen')
      .setStyle(ButtonStyle.Primary),
    new ButtonBuilder()
      .setCustomId('securitysetup-nav-lockdown')
      .setLabel('🔒 Lockdown')
      .setStyle(ButtonStyle.Primary),
  );

  // ROW 3: System Toggle + Navigation
